...
const Home = () => {
  return (
    ...
    circle w-[100%] h-full rounded-full md:px-6"
      ...
      <section className="min-h-screen py-3 mt-22 flex items-center justify-center">
          ...
          <div className="right">
            <div className="h-auto w-[100%]">
              <div className="mt-5 md:mt-10 lg:mt-0 md:px-10">
                <h3 className="font-dmsans-reg text-center tracking-wide text-4xl md:text-5xl text-secondary">
      ...
      <section className="h-screen border border-green-600">
