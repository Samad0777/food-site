...
const Home = () => {
  ...
  return (
    ...
    circle w-[100%] h-full rounded-full md:px-6"
          ...
          <div className="right">
            <div className="h-auto w-[100%]">
              <div className="mt-5 md:mt-10 lg:mt-0 md:px-10">
                <h3 className="font-playfair text-center tracking-wide text-4xl md:text-5xl text-secondary">
            ...
            <Link to='/about'>
            <button className='mx-2 font-dmsans border rounded-4xl xl:px-6  px-6 py-3.5 cursor-pointer
        transition-all duration-300 ease-in-out hover:bg-primary hover:text-white'>
            More About Us
            </button>
            </Link> 
      ...
      <section className="h-auto flex items-center py-10 justify-center">
        <div className="h-[100%] w-[90%]">
    <div className=" px-4 py-4 md:py-12 w-[100%] text-center ">
      <h3 className="font-playfair text-3xl md:text-4xl text-start 
      md:px-12 lg:w-[45%] md:w-[80%] md:tracking-wider md:text-start">
        We also offer unique services for your events
      </h3>
    </div>

    <div className="grid h-auto grid-cols-1 grid-rows-4 space-x-4 items-center ml-6
     mr-2 sm:grid-cols-2 sm:grid-rows-2 md:grid-cols-3 md:grid-rows-2 lg:grid-cols-4 lg:grid-rows-1">
      ...
      px-2 py-2 text-center w-[98%] h-[100%]  rounded-2xl"
          >
              <img src={items.img} className="h-[100%] w-[90%]" alt="eventsImg" />
